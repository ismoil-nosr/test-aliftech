...
@section('content')
    ...
    <form action="{{ route('contacts.update', $contact->name) }}" method="post">
        @csrf
        @method('PATCH')
        ...
        <div class="row top">
            ...
            <div class="menu-back">
                <span>Редактирование контакта</span>
            </div>
            <div class="menu-edit">
        ...
        <div class="new-contact-form">
            ...
            <div class="phone-inputs">
                ...
                @if ($phones = old('phones') ?? $contact->phones)
                    @foreach ($phones as $k => $phone)
                        <input type="text" name="phones[]"
                            class="new-input {{ $errors->has('phones.' . $k) ? 'error' : '' }}"
                            placeholder="+8 (800) 555-35-35" value="{{ $phone->value ?? $phone }}">
            ...
            <div class="email-inputs">
                ...
                <br>
                @if ($emails = old('emails') ?? $contact->emails)
